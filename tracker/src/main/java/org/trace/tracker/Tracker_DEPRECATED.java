...
@Deprecated
public class Tracker_DEPRECATED {
    ...
    private Tracker_DEPRECATED(Context context, Messenger messenger){
    ...
    private static Tracker_DEPRECATED TRACKERDEPRECATED = null;

    public static Tracker_DEPRECATED getInstance(Context context, Messenger messenger){
        synchronized (Tracker_DEPRECATED.class){
            if(TRACKERDEPRECATED == null)
                TRACKERDEPRECATED = new Tracker_DEPRECATED(context,messenger);
        }
    ...
    /**
     * TODO: limpa tudo...
     * This method should be invoked when the Tracker_DEPRECATED is no longer required for the forseeable
    ...
    public List<TrackSummary> getAllTracedTracks(Context context){
        ...
        throw new RuntimeException("getAllTracedTracks@Tracker_DEPRECATED is deprecated");
    }
