...
public class FusedLocationModuleOutlierAware implements LocationListener, ModuleInterface {
    ...
    public FusedLocationModuleOutlierAware(Context ctx, GoogleApiClient client) {
        this.mContext = ctx;
